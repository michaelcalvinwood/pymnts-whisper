...
async function getTheFacts (chunk) {
    const prompt = `"""Extract every single idea expressed in the transcript provided below. The return format must be stringified JSON in the following format: {
        "ideas": array of ideas here
        "num": number of ideas here
